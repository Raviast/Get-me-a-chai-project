    ...
    return (
        ...
        <div className="mt-8">
            ...
            <div className="flex items-center">
                <img className="w-20 h-20 rounded-full mr-4" src="avatar.gif" alt="Founder" />
                <div>
                    <h3 className="text-xl font-semibold mb-2">Founder</h3>
                    <p className="text-lg">Meet the visionary behind Get Me a Chai. With a passion for creativity and a drive for innovation, they founded Get Me a Chai to empower creators and support fans on their creative journeys.</p>   
                    {/* Add more information about the founder */}
                    <p className="text-lg mt-2">Founder&apos;s Name: Ravi</p>
                    {/* Add github and linkedin profile */}
                    <p className="text-lg"><a href="https://github.com/Raviast" className="text-blue-500 hover:underline">Github</a></p>
                    <p className="text-lg"><a href="https://www.linkedin.com/in/ravi-astare-557852140/" className="text-blue-500 hover:underline">LinkedIn</a></p>
                </div>
            </div>
        </div>
